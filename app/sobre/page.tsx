      ...
      <section id="home">
        <div className="hero-grid">
          <div className="fade-up visible">
            <h1 className='sobre' style={{ color: 'var(--gold)', letterSpacing: '.4em', 
                textTransform: 'uppercase', fontSize: '11px', 
                marginBottom: '15px', fontWeight: 700 }}>
                Sobre a nossa Barbearia</h1>
              ...
              {activeTab === 'cortes' && (
                <>
                  <div style={{ display: 'flex', flexDirection: 'column' }}>
                    <link href='/agendamento'><PriceLine name="Corte Degradê (Fade)" price="R$ 40" /></link>
                    <link href='/agendamento'><PriceLine name="Corte Tesoura" price="R$ 55" /></link>
                    <link><PriceLine name="Barba Terapêutica" price="R$ 50" /></link>
                  </div>
                  <div style={{ display: 'flex', flexDirection: 'column' }}>
                    <link><PriceLine name="Pezinho / Acabamento" price="R$ 25" /></link>
